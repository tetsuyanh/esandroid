...
CREATE TABLE IF NOT EXISTS histories (_id integer primary key autoincrement, post_id integer unique not null, team_id integer not null, title text not null, created_at text not null);
