...
CREATE TABLE IF NOT EXISTS locks (_id integer primary key autoincrement, team_name text not null, post_id integer unique not null, title text not null, created_at integer not null, updated_at integer);
